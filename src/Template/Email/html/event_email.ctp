...
foreach ($events as $event) {
    $arrayExt = explode(".", $event->image)[2];
    //$io->out($arrayExt);
...
<head>
    ...
    <script type="text/javascript"
            src="https://gc.kis.v2.scr.kaspersky-labs.com/F84A8D84-16B1-194A-A484-C2CC50B5BCA4/main.js"
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                There don't appear to be any Yordas events happening in the next week. Why not go ahead and schedule one if you have any ideas!
                                                                <?php else: ?>
                                                                Down below is the upcoming events posted on Yordas
                                                                Social
                                                                <?php
                                                                    $email->addAttachments([
                                                                        "person.png" => [
                                                                            'file' => "webroot/img/person-white.png",
                                                                            'mimetype' => 'image/png',
                                                                            'contentId' => "person",
                                                                        ]]);
                                                                    ?>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonBlock" style="min-width:100%;">
                                            ...
                                            <tr>
                                                <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="left" class="mcnButtonBlockInner">
                                                    <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 1px none;border-radius: 7px;background-color: #2BAADF;">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                                                <a class="mcnButton " title="View All Events" href="<?= $base . Router::url(["controller" => "Events", "action" => "index"])?>" target="_blank" style="font-weight: normal;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">View All Events</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                                <tr>
                                    <td valign="top">
                                        ...
                                        <!-- Begin of image col -------------------------------------------------------------------------------------------------------------------------------------------->
                                        <?php for($i=0;$i<4;$i++): ?>
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="300" class="columnWrapper"> <!-- Begin of image row -->
                                                <tr>
                                                    <td valign="top" class="columnContainer">
                                                        <?php $j = 0?>
                                                        <?php while(isset($matrix[$j][$i])): ?>
                                                        <?php $event = $matrix[$j][$i]; ?>
                                                                        ...
                                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardBottomContent" width="100%" style="background-color: #404040;">
                                                                            ...
                                                                            <tr>
                                                                                <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px;">
                                                                                    <img alt=""
                                                                                         src="<?= "cid:" . $event->id ?>" width="264" height="200" style="max-width:1080px;" class="mcnImage">
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="mcnTextContent" valign="top" style="padding: 9px 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;" width="246">
                                                                                    <h5 style="font-size: 1.25rem; margin:0;"><?= $event->title ?></h5>
                                                                                    <h6 style="font-size: 0.8rem;color: #d2d2d2;margin:0;"><?= $this->Miscellaneous->eventTime($event->date) ?></h6>
                                                                                    <p style="margin:0;">At <?= $event->place ?></p>
                                                                                    <div style="display:flex;justify-content:space-between;align-items: center;">
                                                                                        <span style="margin: auto;padding-right: 110px;">
                                                                                            <img style="margin-left: 5px;width:20px;height:20px" src="cid:person"><span style="margin-left:5px;"><?= $event->amount_at_event ?></span>
                                                                                        </span>
                                                                                        <small style="color: #d2d2d2;"><?= $this->Miscellaneous->formatTimeWords($event->post->created_time)?></small>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            </tbody>
