...
$url = $base . Router::url(["controller" => "ReportedPosts", "action" => "view"]);
...
<body>
<!--*|IF:MC_PREVIEW_TEXT|*-->
<!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">| New Reported Post |</span><!--<![endif]-->
<!--*|END:IF|*-->
<center>
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                            <tbody><tr>
                                                ...
                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <h1><span style="font-size:20px">A new report has been submitted on a post.</span></h1>
                                                    ...
                                                    <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #404040;">
                                                        <tbody><tr>
                                                            <td valign="top" class="mcnTextContent" style="padding: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
                                                                <div style="text-align: left;"><span style="font-size:24px"><u>Reported By: <?= $report->user->FirstName . " " . $report->user->LastName ?></u></span><br>
                                                                    <br>
                                                                    <em><span style="font-size:18px">Reason:</span></em><br>
                                                                    <?= $report->reason ?>
                                                                </div>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #2BAADF;">
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                                    <a class="mcnButton " title="View Reported Post" href="<?= $url ?>" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">View Reported Post</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
