...
foreach ($post->post_images as $image) {
    $arrayExt = explode(".", $image->image)[2];
    $email->addAttachments([
        "photoC" . $i . "." . $arrayExt => [
            'file' => $this->Miscellaneous->getImage($root_dir . $image->image),
            'mimetype' => 'image/' . $arrayExt,
            'contentId' => "i" . $i,
        ]
    ]);
...
<head>
    ...
    <script>var w=window;if(w.performance||w.mozPerformance||w.msPerformance||w.webkitPerformance){var d=document;AKSB=w.AKSB||{},AKSB.q=AKSB.q||[],AKSB.mark=AKSB.mark||function(e,_){AKSB.q.push(["mark",e,_||(new Date).getTime()])},AKSB.measure=AKSB.measure||function(e,_,t){AKSB.q.push(["measure",e,_,t||(new Date).getTime()])},AKSB.done=AKSB.done||function(e){AKSB.q.push(["done",e])},AKSB.mark("firstbyte",(new Date).getTime()),AKSB.prof={custid:"641052",ustr:"",originlat:"0",clientrtt:"103",ghostip:"104.103.71.148",ipv6:false,pct:"10",clientip:"86.16.228.206",requestid:"baba5e62",region:"25800",protocol:"h2",blver:14,akM:"x",akN:"ae",akTT:"O",akTX:"1",akTI:"baba5e62",ai:"493573",ra:"false",pmgn:"",pmgi:"",pmp:"",qc:""},function(e){var _=d.createElement("script");_.async="async",_.src=e;var t=d.getElementsByTagName("script"),t=t[t.length-1];t.parentNode.insertBefore(_,t)}(("https:"===d.location.protocol?"https:":"http:")+"//ds-aksb-a.akamaihd.net/aksb.min.js")}</script>
</head>
<body>
<!--*|IF:MC_PREVIEW_TEXT|*-->
<!--[if !gte mso 9]><!---->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="center" valign="top" id="templateBody">
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                                <tr>
                                    <td valign="top" class="bodyContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnImageCardBlock">
                                                                            ...
                                                                            <table class="mcnCaptionRightTextContentContainer" align="left" style="margin-top: 8px;padding-left: 5px;width: 94%;padding-bottom: 10px;" border="0" cellpadding="0" cellspacing="0">
                                                                                ...
                                                                                <tr style="padding-bottom: 10px;">
                                                                                    <td valign="top" class="mcnTextContent">
                                                                                        ...
                                                                                        <?= nl2br($this->Miscellaneous->getText($post->content)) ?>
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
                                                                            </table>
                                                                ...
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                                    <tbody><tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <h1 class="null" style="margin: 0px;">Post Images</h1>
                                                                ...
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent">
                                                                    ...
                                                                    <tr>
                                                                        <td class="mcnCaptionBottomImageContent" align="center" valign="top" style="padding:0 9px 9px 9px;">
                                                                            <img alt="" src="<?= "cid:i" . $i ?>" style="max-width:700px;" class="mcnImage">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
