...
$explodeExt = explode(".", $event->image);
$arrayExt = array_pop($explodeExt);

$email->addAttachments([
    "photo" . $event->id . "." . $arrayExt => [
        'file' => $this->Miscellaneous->getImage($root_dir . $event->image),
...
<span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">
    <?= $event->title . " | " . $this->Miscellaneous->toEditTimeFormat($event->date) . " | " . $event->place . " | "?>
</span><!--<![endif]-->
<!--*|END:IF|*-->
<center>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <span style="font-size:32px">New Event Posted</span>
                                                            </td>
                                                        </tr>
                                                        </tbody></table>
                                                    <!--[if mso]>
                                    ...
                                    <td valign="top" class="bodyContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnImageCardBlock">
                                            ...
                                            <tr>
                                                <td class="mcnImageCardBlockInner" valign="top" style="padding-top:9px; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardBottomContent" max-width="100%" style="background-color: #333333;">
                                                        <tbody><tr>
                                                            <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px;">
                                                                <img alt="" src="<?= "cid:" . $event->id ?>" width="564" style="max-width: 1080px; border-radius: 0%;" class="mcnImage">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="mcnTextContent" valign="top" style="color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: left;" width="546">
                                                                <div style="text-align: center;"><strong><span style="font-size:24px"><?= $event->title ?></span><br>
                                                                        <span style="color:#D3D3D3"><?= $this->Miscellaneous->eventTime($event->date) ?></span></strong><br>
                                                                    <?= $event->place ?>
                                                                    <hr></div>

                                                                <h2 class="null" style="text-align: left; padding: 0px 10px 0px 10px;margin: 0px;"><span style="color:#FFFFFF"><span style="font-family:arial,helvetica neue,helvetica,sans-serif">Description:</span></span></h2>

                                                                <div style="text-align: left; padding: 0px 10px 5px 10px;">
                                                                    <?= $event->post->content ?><br>
                                                                    <em>
                                                                        By <?= $event->post->user->FirstName . " " . $event->post->user->LastName ?>
                                                                    </em>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #2BAADF;">
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                                                <a class="mcnButton " title="View All Events" href="<?= $base . Router::url(["controller" => "Events", "action" => "index", "id" => $event->id])?>" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">View Event</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
