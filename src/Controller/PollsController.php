...
class PollsController extends AppController
{
    ...
    public function view($id = null)
    {
        $poll = $this->Polls->get($id, [
            'contain' => ['Posts', 'PollOptions', 'PollVotes']
        ]);
    ...
    public function add() {
        ...
        $posts = $this->Polls->Posts->find('list', ['limit' => 200]);
        $this->set(compact('poll', 'posts'));
    }
    ...
    public function totalVotes(){
        ...
        if($this->request->is("post")){
            $id = $_POST["id"];
            $poll = $this->Polls->find("RenderContent")->where(["id" => $id])->first();
            $this->set("poll",$poll);
            return;
        }
